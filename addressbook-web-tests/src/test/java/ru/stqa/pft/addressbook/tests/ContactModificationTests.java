...
public class ContactModificationTests extends TestBase {
  ...
  public void ensurePreconditions() {
    ...
    if (app.contact().all().size() == 0) {
      app.contact().create(new ContactData()
              ...
              .withCompany("AT").withGroup("test1").withHomePhone("123456789").withWorkPhone("123456789").withEmail("test@test.com"), true);
    }
  }
  ...
  public void testContactModification() {
    ...
    ContactData contact = new ContactData().withId(modifiedContact.getId()).withFirstname("John").withMiddlename("Kenny").withLastname("Johnas")
            .withAddress("LA").withNickname("Johny").withMobilePhone("123456789")
            .withCompany("AT").withGroup("test1").withHomePhone("123456789").withWorkPhone("123456789").withEmail("test@test.com");
